/*
 *此程序对book247.cpp略作修改，用于测试多进程的socket通信客户端
...
int main()
{
  ...
  // 向服务器发起连接请求
  if (TcpClient.ConnectToServer("172.16.187.203",5051)==false)
  { printf("TcpClient.ConnectToServer(\"172.16.187.203\",5051) failed,exit...\n"); return -1; }
